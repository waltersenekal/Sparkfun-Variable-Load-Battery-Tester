...
#define CapSense_TOTAL_SENSOR_COUNT            (4u)
#define CapSense_TOTAL_SCANSLOT_COUNT            (4u)
#define CapSense_TOTAL_RB_NUMBER            (1u)
#define CapSense_TOTAL_RB_NUMBER__CH0            (1u)

/* Define Sensors */
#define CapSense_SENSOR_BACK__BTN    (0u)
#define CapSense_SENSOR_ENTER__BTN    (1u)
#define CapSense_SENSOR_DOWN__BTN    (2u)
#define CapSense_SENSOR_UP__BTN    (3u)
