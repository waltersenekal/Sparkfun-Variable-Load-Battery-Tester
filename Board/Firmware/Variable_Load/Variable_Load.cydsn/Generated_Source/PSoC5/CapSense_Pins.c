...
{
    /* Set pins drive mode */
    CyPins_SetPinDriveMode(CapSense_PortCH0__BACK__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__ENTER__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__DOWN__BTN, mode);
    CyPins_SetPinDriveMode(CapSense_PortCH0__UP__BTN, mode);
