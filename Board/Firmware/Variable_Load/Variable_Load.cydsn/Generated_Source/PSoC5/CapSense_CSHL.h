...
#define CapSense_BACK__BTN        (0u)
#define CapSense_ENTER__BTN        (1u)
#define CapSense_DOWN__BTN        (2u)
#define CapSense_UP__BTN        (3u)
...
#define CapSense_TOTAL_BUTTONS_COUNT                 (4u)
...
#define CapSense_UNUSED_DEBOUNCE_COUNTER_INDEX   (4u)


#define CapSense_END_OF_SLIDERS_INDEX   (0u)
#define CapSense_END_OF_TOUCH_PAD_INDEX   (0u)
#define CapSense_END_OF_BUTTONS_INDEX   (3u)
#define CapSense_END_OF_MATRIX_BUTTONS_INDEX   (3u)
#define CapSense_END_OF_WIDGETS_INDEX   (4u)
