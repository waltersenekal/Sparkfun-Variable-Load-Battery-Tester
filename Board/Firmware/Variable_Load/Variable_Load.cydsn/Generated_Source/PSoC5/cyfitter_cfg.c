...
#define cy_cfg_data_table ((const cy_cfg_addrvalue_t CYFAR *)(0x48000088u + CYAPP_ECC_OFFSET))

/* UDB_0_2_1_CONFIG Address: CYDEV_UCFG_B0_P4_U0_BASE Size (bytes): 128 */
#define BS_UDB_0_2_1_CONFIG_VAL ((const uint8 CYFAR *)(0x48000644u + CYAPP_ECC_OFFSET))

/* IOPINS0_0 Address: CYREG_PRT0_DM0 Size (bytes): 8 */
#define BS_IOPINS0_0_VAL ((const uint8 CYFAR *)(0x480006C4u + CYAPP_ECC_OFFSET))

/* IOPINS0_7 Address: CYREG_PRT12_DR Size (bytes): 10 */
#define BS_IOPINS0_7_VAL ((const uint8 CYFAR *)(0x480006CCu + CYAPP_ECC_OFFSET))

/* IOPINS0_8 Address: CYREG_PRT15_DR Size (bytes): 10 */
#define BS_IOPINS0_8_VAL ((const uint8 CYFAR *)(0x480006D8u + CYAPP_ECC_OFFSET))

/* IOPINS0_1 Address: CYREG_PRT1_DR Size (bytes): 10 */
#define BS_IOPINS0_1_VAL ((const uint8 CYFAR *)(0x480006E4u + CYAPP_ECC_OFFSET))

/* IOPINS0_2 Address: CYREG_PRT2_DM0 Size (bytes): 8 */
#define BS_IOPINS0_2_VAL ((const uint8 CYFAR *)(0x480006F0u + CYAPP_ECC_OFFSET))

/* IOPINS0_3 Address: CYREG_PRT3_DM0 Size (bytes): 8 */
#define BS_IOPINS0_3_VAL ((const uint8 CYFAR *)(0x480006F8u + CYAPP_ECC_OFFSET))

/* CYDEV_CLKDIST_ACFG0_CFG0 Address: CYREG_CLKDIST_ACFG0_CFG0 Size (bytes): 8 */
#define BS_CYDEV_CLKDIST_ACFG0_CFG0_VAL ((const uint8 CYFAR *)(0x48000700u + CYAPP_ECC_OFFSET))

/* PHUB_CFGMEM10 Address: CYREG_PHUB_CFGMEM10_CFG0 Size (bytes): 4 */
#define BS_PHUB_CFGMEM10_VAL ((const uint8 CYFAR *)(0x48000708u + CYAPP_ECC_OFFSET))
...
static void AnalogSetDefault(void)
{
	...
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT1_AG, 0xC0u);
	CY_SET_XTND_REG8((void CYFAR *)CYREG_PRT2_AG, 0x10u);
	CY_SET_XTND_REG16((void CYFAR *)CYREG_PRT3_AMUX, 0x9008u);
	...
	CY_SET_XTND_REG16((void CYFAR *)CYREG_OPAMP1_MX, 0x0102u);
