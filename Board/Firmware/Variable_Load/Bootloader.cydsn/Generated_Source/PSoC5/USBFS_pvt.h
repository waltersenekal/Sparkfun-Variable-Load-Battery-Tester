...
extern const uint8 CYCODE USBFS_DEVICE0_CONFIGURATION0_DESCR[25u];
extern const uint8 CYCODE USBFS_DEVICE1_DESCR[18u];
extern const uint8 CYCODE USBFS_DEVICE1_CONFIGURATION0_DESCR[41u];
extern const T_USBFS_EP_SETTINGS_BLOCK CYCODE USBFS_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[1u];
...
extern const T_USBFS_LUT CYCODE USBFS_DEVICE1_CONFIGURATION0_INTERFACE0_TABLE[1u];
extern const T_USBFS_EP_SETTINGS_BLOCK CYCODE USBFS_DEVICE1_CONFIGURATION0_EP_SETTINGS_TABLE[2u];
extern const uint8 CYCODE USBFS_DEVICE1_CONFIGURATION0_INTERFACE_CLASS[1u];
extern const T_USBFS_LUT CYCODE USBFS_DEVICE1_CONFIGURATION0_TABLE[4u];
extern const T_USBFS_LUT CYCODE USBFS_DEVICE1_TABLE[3u];
extern const T_USBFS_LUT CYCODE USBFS_TABLE[2u];
extern const uint8 CYCODE USBFS_SN_STRING_DESCRIPTOR[10];
extern const uint8 CYCODE USBFS_STRING_DESCRIPTORS[83u];
extern T_USBFS_XFER_STATUS_BLOCK USBFS_DEVICE1_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_RPT_SCB;
extern uint8 USBFS_DEVICE1_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_BUF[
            USBFS_DEVICE1_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_BUF_SIZE];
extern T_USBFS_XFER_STATUS_BLOCK USBFS_DEVICE1_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_RPT_SCB;
extern uint8 USBFS_DEVICE1_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_BUF[
...
extern const T_USBFS_TD CYCODE USBFS_DEVICE1_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_RPT_TABLE[1u];
extern const T_USBFS_TD CYCODE USBFS_DEVICE1_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_RPT_TABLE[1u];
extern const T_USBFS_LUT CYCODE USBFS_DEVICE1_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_TABLE[5u];
