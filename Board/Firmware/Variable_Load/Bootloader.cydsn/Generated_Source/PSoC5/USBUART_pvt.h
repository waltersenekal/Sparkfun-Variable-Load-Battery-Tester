...
extern const uint8 CYCODE USBUART_DEVICE0_CONFIGURATION0_DESCR[41u];
extern const T_USBUART_LUT CYCODE USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_TABLE[1u];
extern const T_USBUART_EP_SETTINGS_BLOCK CYCODE USBUART_DEVICE0_CONFIGURATION0_EP_SETTINGS_TABLE[2u];
extern const uint8 CYCODE USBUART_DEVICE0_CONFIGURATION0_INTERFACE_CLASS[1u];
extern const T_USBUART_LUT CYCODE USBUART_DEVICE0_CONFIGURATION0_TABLE[4u];
extern const T_USBUART_LUT CYCODE USBUART_DEVICE0_TABLE[3u];
extern const T_USBUART_LUT CYCODE USBUART_TABLE[1u];
extern const uint8 CYCODE USBUART_SN_STRING_DESCRIPTOR[10];
extern const uint8 CYCODE USBUART_STRING_DESCRIPTORS[83u];
extern T_USBUART_XFER_STATUS_BLOCK USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_RPT_SCB;
extern uint8 USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_BUF[
            USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_BUF_SIZE];
extern T_USBUART_XFER_STATUS_BLOCK USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_RPT_SCB;
extern uint8 USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_BUF[
            USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_BUF_SIZE];
extern const uint8 CYCODE USBUART_HIDREPORT_DESCRIPTOR1[40u];
extern const uint8 CYCODE USBUART_HIDREPORT_DESCRIPTOR2[40u];
extern const uint8 CYCODE USBUART_HIDREPORT_DESCRIPTOR3[40u];
extern const T_USBUART_TD CYCODE USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_IN_RPT_TABLE[1u];
extern const T_USBUART_TD CYCODE USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_OUT_RPT_TABLE[1u];
extern const T_USBUART_LUT CYCODE USBUART_DEVICE0_CONFIGURATION0_INTERFACE0_ALTERNATE0_HID_TABLE[5u];
